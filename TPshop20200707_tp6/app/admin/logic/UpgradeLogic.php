...
class UpgradeLogic 
{
    ...
    function  __construct() {
        ...
        $this->app_path = APP_PATH; // 当前项目路径
        $this->version_txt_path = $this->app_path.'admin/config/version.html'; // 版本文件路径
    ...
    */
    ...
    public  function OneKeyUpgrade(){
        ...
        if(!file_exists($this->app_path.'backup/'.$folderName.'/www/admin/config/version.html'))
